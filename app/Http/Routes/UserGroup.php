...
Route::group(['middleware' => 'token'], function () {
    ...
    Route::group(['prefix' => 'user-group'], function () {
        ...
        Route::post('{id}/notice/create', 'UserGroup\NoticeController@addNotice');
        Route::get('/{groupId}/notice/{id}', 'UserGroup\NoticeController@getNotice');
        Route::get('/{id}/notices', 'UserGroup\NoticeController@getGroupNotices');
        Route::get('/{groupId}/notice/{noticeId}/delete', 'UserGroup\NoticeController@deleteNotice');
